...
const User_1 = require("../models/User"); // Modelo/entidade User
const data_source_1 = __importDefault(require("../config/data-source")); // Configuração da conexão com o banco de dados
const bcryptjs_1 = __importDefault(require("bcryptjs")); // Biblioteca para hash de senhas
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken")); // Biblioteca para manipulação de Tokens JWT (Authenticação)
const dotenv_1 = __importDefault(require("dotenv")); // Biblioteca para carregar variáveis de ambiente
dotenv_1.default.config(); // Carrega as variáveis de ambiente do arquivo .env
const JWT_SECRET = process.env.JWT_SECRET; // Obtém a chave secreta para JWT do ambiente
